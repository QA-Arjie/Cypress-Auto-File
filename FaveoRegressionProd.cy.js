...
describe('Faveo Prod Test', () => {
    ...
    it('TC01: Create Ticket', () => {
        cy.visit('*************')
          ...
          cy.wait(1000);
          // Requester
          cy.get('#requester').type('Arjie Test').should('have.value', 'Arjie Test')
          cy.wait(1000)
          cy.get('#vs13__option-0 > .d-center').click();
          ...
          cy.get('#vs14__option-0 > .d-center').click();
          // Status
          cy.get('#status_id').click();
          cy.get('#vs15__option-0 > .d-center').click();
          // Type
          cy.get('#type_id').click();
          cy.get('#vs16__option-2 > .d-center').click();
          // Priority
          cy.get('#priority_id').click();
          cy.get('#vs17__option-1 > .d-center').click();
          // Department
          cy.get('#department_id').click();
          cy.get('#vs18__option-3 > .d-center').click();
          // Submit ticket //
    ...
    it('TC02: Reply to Ticket', () => {
        ...
        .contains('Arjie Test')
        .should('be.visible')
        cy.get(':nth-child(9) > .row > .inbox-info > .inline-block > :nth-child(1) > .user_name > .emphasize')
    ...
    after(() => {
      ...
      cy.task('writeCSV', {
        filePath: `cypress/results/test-results-${timestamp}.csv`,
